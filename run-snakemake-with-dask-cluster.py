...
if __name__ == '__main__':
    ...
    print(f"Created cluster {cluster.__class__.__name__} at {cluster.scheduler_address}")
    ...
    #Run snakemake with the args that this script was called with, adding in the scheduler address as a config
